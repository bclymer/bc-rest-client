...
public class RestClient {
     ...
     * @param clazz Class to cast response to
     * @param callback Class to call methods in upon completion of request.
     * @param headers Array of headers to be added to this request.
     * @param params HttpParams to be added to this request.
     * @return An int which will be the ID of that request. You can use this to cancel the request.
     */
     ...
     * @param headers Array of headers to be added to this request.
     * @param params HttpParams to be added to this request.
     * @return A Response object containing the response data and error information.
     */
     ...
     * @param headers Array of headers to be added to this request.
     * @param params HttpParams to be added to this request.
     * @param body An object to be converted to JSON and attached to the request.
     * @return An int which will be the ID of that request. You can use this to cancel the request.
     */
	public <T> int post(String url, Class<T> clazz, RestCallback<T> callback, Header[] headers, HttpParams params, Object body) {
     ...
     * @return A Response object containing the response data and error information.
     */
	public <T> Response<T> postSync(String url, Class<T> clazz, RestCallback<T> callback, Header[] headers, HttpParams params, Object body) {
		HttpPost request = new HttpPost(url);
		setupRequest(request, headers, params);
		if (body != null) {
			try {
     ...
     * @return An int which will be the ID of that request. You can use this to cancel the request.
     */
	public <T> int put(String url, Class<T> clazz, RestCallback<T> callback, Header[] headers, HttpParams params, Object body) {
     ...
     * @return A Response object containing the response data and error information.
     */
	public <T> Response<T> putSync(String url, Class<T> clazz, RestCallback<T> callback, Header[] headers, HttpParams params, Object body) throws UnsupportedEncodingException, JsonProcessingException {
		HttpPut request = new HttpPut(url);
		setupRequest(request, headers, params);
		if (body != null) {
			StringEntity bodyString = new StringEntity(mMapper.writeValueAsString(body));
     ...
     * @return A Response object containing the response data and error information.
     */
	public <T> Response<T> deleteSync(String url, Class<T> clazz, RestCallback<T> callback, Header[] headers, HttpParams params) {
		HttpDelete request = new HttpDelete(url);
		setupRequest(request, headers, params);
		return performSyncRequest(request, clazz);
	}
